...
function AppContent() {
    ...
    if (!completedModules.includes(moduleNumber)) {
      ...
      if (
        ...
        try {
          ...
          console.log(
            `Progress saved for ${moduleName}: ${score}/${totalQuestions}`
          );
  ...
  return (
    <div className="App bg-gray-50">
      {currentPage !== "module1" &&
        ...
        currentPage !== "task2" && (
          <Navbar
            ...
            onGoHome={handleBackToHome} // critical: wire Home + brand logo here
      ...
      {/* Page Rendering */}
      {currentPage === "home" && <Home onStartLearning={handleStartLearning} />}
            ...
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50">
              <div className="text-center bg-white p-8 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600 mb-6">
                  You need to sign in to access the learning path.
                </p>
                <button
      ...
      {currentPage === "module1" && (
        <Module1
          ...
          onBackToPath={() => setCurrentPage("learning")}
        />
      )}
      {currentPage === "module2" && (
        <Module2
      ...
      {currentPage === "installation" && (
        <Installation
          ...
          onBackToLearning={() => setCurrentPage("learning")}
        />
      )}
      {currentPage === "task1" && (
        <Task1
